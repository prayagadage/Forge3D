  ...
  const renderField = (name, label, opts = {}) => (
    <div className="input-group">
      ...
      <input
        ...
        autoComplete={opts.autoComplete || name}
      />
          ...
          <div className="checkout-layout">
            ...
            <div>
              ...
              <div className="checkout-section">
                ...
                <div style={{
                  ...
                  <p style={{ marginBottom: 'var(--sp-2)', fontWeight: 'var(--fw-semibold)', color: 'var(--text-primary)' }}>
                    💳 Payment Integration
                  </p>
                  <p>Payment processing will be connected here. For now, click "Place Order" to simulate checkout.</p>
                </div>
              </div>
            ...
            <div className="order-summary-card">
              ...
              <div className="price-summary" style={{ background: 'transparent', padding: 'var(--sp-4) 0 0' }}>
                ...
                {shipping > 0 && (
                  <div style={{ fontSize: 'var(--fs-caption)', color: 'var(--primary-accent)', marginBottom: 'var(--sp-2)' }}>
