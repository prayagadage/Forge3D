      ...
      <div className="container">
        <div className="footer__inner">
          <div className="footer__grid">
            {/* Brand */}
            <div>
              <Link to="/" className="navbar__logo" style={{ display: 'inline-flex' }}>
            ...
            <div>
              ...
              <Link to="/explore" className="footer__link">Shop Models</Link>
              <Link to="/custom-print" className="footer__link">Print Custom</Link>
              <Link to="/explore" className="footer__link">Material Guide</Link>
            </div>
